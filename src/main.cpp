...
const string strMessageMagic = "EnigmaCoin Signed Message:\n";
...
const int YEARLY_BLOCKCOUNT =  438000;
...
int64_t GetProofOfStakeReward(int64_t nCoinAge, int64_t nFees)
{
    ...
    else if (pindexBest->nHeight+1 <= 2*YEARLY_BLOCKCOUNT)
    {
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "EnigmaCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "Sat, 05 Mar 2016 17:20:37 GMT";
        CTransaction txNew;
        txNew.nTime = 1457198437;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("0x2ab90555053a12375ccd10133042ccb13dfa8914784f7b8f6502da008d0d4a8c"));
        block.print();
